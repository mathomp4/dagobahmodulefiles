...
--
-- $ mkdir build-nag-7.1.37 && cd build-nag-7.1.37
-- $ ../configure --disable-wrapper-rpath --disable-wrapper-runpath \
--    --with-hwloc=internal --with-libevent=internal --with-pmix=internal \
--     --prefix=$HOME/installed/Compiler/nag-7.1.37/openmpi/5.0.0rc12 |& tee configure.nag-7.1.37.log
--
-- $ mv config.log config.nag-7.1.37.log
-- $ make -j4 |& tee make.nag-7.1.37.log
-- $ make install |& tee makeinstall.nag-7.1.37.log
-- $ make check |& tee makecheck.nag-7.1.37.log
--
-- ]]
...
local mdir = pathJoin(mroot,"MPI/nag-7.1.37",("openmpi-"..version))
