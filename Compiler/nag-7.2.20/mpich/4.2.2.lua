...
../configure CC=clang CXX=clang++ FC=nagfor \
   ...
   CFLAGS="-I$HOME/installed/Core/nag/7.2.20/lib/NAG_Fortran" \
   --prefix=$HOME/installed/Compiler/nag-7.2.20/mpich/4.2.2 |& tee configure.nag-7.2.20.log
...
local mdir = pathJoin(mroot,"MPI/nag-7.2.20",("mpich-"..version))
