...
and I ran
  ...
  ./install_miniforge.bash --python_version 3.13 --miniforge_version 25.3.0-3 --prefix /Users/mathomp4/installed/Core/GEOSpyD |& tee install.25.3.0-3_py3.13.log
...
local miniforge_version = "25.3.0-3"
local python_version = "py3.13"
local builddate = "2025-06-16"
