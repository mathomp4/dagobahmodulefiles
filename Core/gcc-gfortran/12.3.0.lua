...
--       macOS now
--
-- NOTE2: The CC, CXX and --with-ld were added per comment by @iains as a test to fix XCode 15 + GCC 
--        build issues. This is *NOT* a permanent solution. The correct fix is to wait for XCode to
--        fix their end...but that could take a while.
--
...
--      CC=clang CXX=clang++ --with-ld=/Library/Developer/CommandLineTools/usr/bin/ld-classic \
