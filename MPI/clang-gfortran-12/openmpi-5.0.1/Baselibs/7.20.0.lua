...
--
--   git clone -j 4 --recurse-submodules -b v7.20.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-7.20.0/src
--
-- This was built using:
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-12/openmpi-5.0.1/Baselibs/7.20.0/Darwin |& tee makeinstall.clang-gfortran-12_openmpi-5.0.1.log
--
