...
-- $ make -j6 install ESMF_COMM=mpich ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.1.43/mpich-4.2.0/Baselibs/7.18.1/Darwin |& tee makeinstall.nag-7.1.43_mpich-4.2.0.log
--
...
family("Baselibs")
prereq("nag/7.1.43", "mpich/4.2.0")

local compilername = "nag-7.1.43"
local mpiname = "mpich-4.2.0"

local version = "7.18.1"
