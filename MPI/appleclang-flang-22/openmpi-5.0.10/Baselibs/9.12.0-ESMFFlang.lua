...
git clone -j 4 --recurse-submodules -b v9.12.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-9.12.0-ESMFFlang/src
...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=llvm ESMF_BOPT=g prefix=$HOME/installed/MPI/appleclang-flang-22/openmpi-5.0.10/Baselibs/9.12.0-ESMFFlang/Darwin |& tee makeinstall.appleclang-flang-22_openmpi-5.0.10.log
