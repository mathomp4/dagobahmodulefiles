...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.2.23/openmpi-5.0.6/Baselibs/8.9.0-TEST/Darwin |& tee makeinstall.nag-7.2.23_openmpi-5.0.6.log
...
family("Baselibs")
prereq("nag/7.2.23", "openmpi/5.0.6")
