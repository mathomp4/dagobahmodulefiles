...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-12.2-from-dmg/openmpi-5.0.0rc12/Baselibs/7.14.0/Darwin |& tee makeinstall.clang-gfortran-12.2-from-dmg-5.0.0rc12.log
--
