...
git clone -j 4 --recurse-submodules -b v8.28.0 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.28.0/src
...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang ESMF_BOPT=g prefix=$HOME/installed/MPI/clang-gfortran-15/openmpi-5.0.7/Baselibs/8.28.0/Darwin |& tee makeinstall.clang-gfortran-15_openmpi-5.0.7.log
