...
git clone -j 4 --recurse-submodules -b v8.23.1 https://github.com/GEOS-ESM/ESMA-Baselibs.git ESMA-Baselibs-8.23.1/src

This was built using:

ml clang-gfortran/15 openmpi/5.0.7

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-15/openmpi-5.0.7/Baselibs/8.23.1/Darwin |& tee makeinstall.clang-gfortran-15_openmpi-5.0.7.log
