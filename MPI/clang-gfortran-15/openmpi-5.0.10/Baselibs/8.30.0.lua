...
make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang ESMF_BOPT=g prefix=$HOME/installed/MPI/clang-gfortran-15/openmpi-5.0.10/Baselibs/8.30.0/Darwin |& tee makeinstall.clang-gfortran-15_openmpi-5.0.10.log
