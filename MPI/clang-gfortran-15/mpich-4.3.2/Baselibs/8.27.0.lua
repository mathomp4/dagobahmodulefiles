...
ml clang-gfortran/15 mpich/4.3.2

NOTE: We seem to need ESMF_BOPT=g again to avoid some ESMF/MAPL issues

make -j6 install ESMF_COMM=mpich ESMF_COMPILER=gfortranclang ESMF_BOPT=g prefix=$HOME/installed/MPI/clang-gfortran-15/mpich-4.3.2/Baselibs/8.27.0/Darwin |& tee makeinstall.clang-gfortran-15_mpich-4.3.2.log
