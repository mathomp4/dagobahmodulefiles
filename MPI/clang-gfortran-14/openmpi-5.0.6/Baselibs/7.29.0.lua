...
ml clang-gfortran/14 openmpi/5.0.6

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=$HOME/installed/MPI/clang-gfortran-14/openmpi-5.0.6/Baselibs/7.29.0/Darwin |& tee makeinstall.clang-gfortran-14_openmpi-5.0.6.log
