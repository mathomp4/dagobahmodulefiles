...
ml gcc-gfortran/14 openmpi/5.0.6

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-14/openmpi-5.0.6/Baselibs/8.13.0/Darwin |& tee makeinstall.gcc-gfortran-14_openmpi-5.0.6.log
