...
ml gcc-gfortran/14 openmpi/4.1.8

make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-14/openmpi-4.1.8/Baselibs/8.13.0/Darwin |& tee makeinstall.gcc-gfortran-14_openmpi-4.1.8.log
